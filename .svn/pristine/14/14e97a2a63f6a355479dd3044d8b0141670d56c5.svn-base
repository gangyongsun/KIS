...
DROP TABLE IF EXISTS `t_termoperate`;
CREATE TABLE `t_termoperate` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自动递增',
  `termId` int(11) NOT NULL COMMENT '术语条目ID',
  `empNO` varchar(32) COLLATE utf8_bin NOT NULL COMMENT '人员编码',
  `praise` tinyint(1) DEFAULT NULL COMMENT '是否赞',
  `trample` tinyint(1) DEFAULT NULL COMMENT '是否踩',
  `collect` tinyint(1) DEFAULT NULL COMMENT '是否收藏',
  `remark` text COLLATE utf8_bin COMMENT '评论内容',
  PRIMARY KEY (`id`)
...
create table t_search_log(
    ...
    `isAccurate` tinyint DEFAULT 0 NOT NULL COMMENT '0代表无匹配搜索内容；1代表精确匹配搜索内容；2代表分词匹配搜索内容',
	PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=UTF8MB4;
...
CREATE TABLE `organization` (
  `orgCode` varchar(32) NOT NULL COMMENT '所在组织编号',
  `orgName` varchar(64) NOT NULL COMMENT '所在组织名称',
  `parentOrgCode` varchar(32) DEFAULT NULL COMMENT '上级组织编号',
  `parentOrgName` varchar(64) DEFAULT NULL COMMENT '上级组织名称',
  `orgDirectorLeader` varchar(64) DEFAULT NULL COMMENT '所在组织直管领导',
  `orgBranchLeader` varchar(64) DEFAULT NULL COMMENT '所在组织分管领导',
  `orgPostCode` varchar(32) DEFAULT NULL COMMENT '分管领导编号',
  `jglb` varchar(64) DEFAULT NULL COMMENT '机构类比',
  `jgbm` varchar(32) DEFAULT NULL COMMENT '机构编码',
  `orgEName` varchar(128) DEFAULT NULL COMMENT '所在组织英文名称 部门英文名称',
  PRIMARY KEY (`orgCode`)
...
CREATE TABLE `employees` (
  `userId` varchar(32) NOT NULL COMMENT '人员编码',
  `userName` varchar(64) NOT NULL COMMENT '人员姓名',
  `unitId` varchar(32) DEFAULT NULL COMMENT '所在单位编码',
  `unitTxt` varchar(128) DEFAULT NULL COMMENT '所在单位名称',
  `systemId` varchar(32) DEFAULT NULL COMMENT '所属系统编码',
  `systemTxt` varchar(128) DEFAULT NULL COMMENT '所属系统名称',
  `stell` varchar(32) DEFAULT NULL COMMENT '岗位编码',
  `stext` varchar(64) DEFAULT NULL COMMENT '岗位名称',
  `deptId` varchar(32) DEFAULT NULL COMMENT '所在部门编码',
  `deptName` varchar(64) DEFAULT NULL COMMENT '所在部门名称',
  `zhrOtext` varchar(64) DEFAULT NULL COMMENT '人员直属组织名称',
  `phoneNumber` varchar(32) DEFAULT NULL COMMENT '电话',
  `email` varchar(128) DEFAULT NULL COMMENT 'email',
  `centerId` varchar(32) DEFAULT NULL COMMENT '所在中心编码',
  `centerTxt` varchar(128) DEFAULT NULL COMMENT '所在中心名称',
  `zhrTime1` varchar(32) DEFAULT NULL COMMENT '入司日期',
  `zhrRzrq` varchar(32) DEFAULT NULL COMMENT '入职日期',
  `orgeh` varchar(32) DEFAULT NULL COMMENT '人员直属组织编码',
  `officeId` varchar(32) DEFAULT NULL COMMENT '所在科室编码',
  `officeTxt` varchar(128) DEFAULT NULL COMMENT '所在科室名称',
  `directorCode` varchar(32) DEFAULT NULL COMMENT '人员直管领导编码',
  `branchCode` varchar(32) DEFAULT NULL COMMENT '人员分管领导编码',
  `zhrCost` varchar(32) DEFAULT NULL COMMENT '成本中心编码',
  `zhrCostTxt` varchar(128) DEFAULT NULL COMMENT '成本中心名称',
  PRIMARY KEY (`userId`)
