        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function (value, row, index) {
                	var detail_content=
                		'<shiro:hasPermission name="user/onlinedetail">'+
                		'<a class="btn btn-outline btn-info btn-sm" onclick="onlineDetail(\''+ row.sessionId +'\')"><span class="fa fa-info"></span> 详情</a>'+
                		'</shiro:hasPermission>&nbsp;';
					var deactive_content=
						'<shiro:hasPermission name="user/onlinedeactive">'+
						'<a class="btn btn-outline btn-warning btn-sm" onclick="changeSessionStatus(\''+row.sessionId +'\',\''+ false +'\')"><span class="fa fa-toggle-off"></span> 踢出</a>'+
						'</shiro:hasPermission>&nbsp;';
					var active_content=
						'<shiro:hasPermission name="user/onlineactive">'+
						'<a class="btn btn-outline btn-success btn-sm" onclick="changeSessionStatus(\''+row.sessionId +'\',\''+ true +'\')"><span class="fa fa-toggle-on"></span> 激活</a>'+
						'</shiro:hasPermission>';
