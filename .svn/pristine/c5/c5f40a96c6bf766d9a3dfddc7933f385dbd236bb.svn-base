package cn.com.goldwind.kis.shiro.config;
...
import cn.com.goldwind.kis.shiro.secutity.KickoutSessionControlFilter;
import cn.com.goldwind.kis.shiro.secutity.MyShiroRealm;
...
//		filterChainDefinitionMap.put("/static/img/**", "anon");
		...
		filterChainDefinitionMap.put("/kis/*", "anon");
	...
	public RedisManager redisManager() {
		...
		redisManager.setHost(PropertiesUtil.getValueByKey("redisServer", "config.properties"));
