        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function (value, row, index) {//自定义显示，也可以写标签
            		...
            		'<a class="btn btn-info btn-sm" onclick="javascript:edit('+row.id +',\''+row.resourceName +'\',\''+row.resourceUrl +'\','+row.resourceType +','+row.parentId +','+row.resourceSort +');"><span class="glyphicon glyphicon-edit"></span> 编辑</a>'+
            		'</shiro:hasPermission>'+
